module.exports = function(eleventyConfig) {
  ...
  eleventyConfig.addGlobalData("navigation", {
    en: [
      ...
      { title: "Case 001 — Mode Validity Drift", url: pathPrefix + "/en/case-001-mode-validity-drift/" },
    ...
    ua: [
      ...
      { title: "Випадок 001 — Дрейф валідності режиму", url: pathPrefix + "/ua/case-001-mode-validity-drift/" },
