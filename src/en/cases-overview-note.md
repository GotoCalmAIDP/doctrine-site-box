---
layout: base.njk
title: "Cases Overview Note — How the Cases Relate"
lang: en
---
...
Purpose:
This note provides a structural overview of the illustrative cases published within the doctrine. It exists to clarify how cases differ, what type of boundary each case documents, and what remains explainable in each.
...
Without an overview, cases may appear as isolated examples.
This note prevents that misreading by showing how cases relate structurally.
...
No case is exhaustive.
Each case isolates one boundary.
